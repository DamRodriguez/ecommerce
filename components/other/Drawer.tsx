...
const Drawer = ({
  ...
  position = "right",
  closeButton = <X className="fill-[#fff]" />,
      ...
      {visible && (
        <>
          <motion.div
            ...
            className={clsx(
              "fixed top-0 z-99 w-full h-screen overflow-hidden",
          ...
          {!hideOverlay && (
            <motion.div
              ...
              className={clsx(
                "fixed z-9999 top-0 left-0 right-0 w-screen bg-black/65 h-screen custom-transition-all",
                overlayClassName,
              )}
            />
          )}
