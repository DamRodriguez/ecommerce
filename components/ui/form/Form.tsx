...
} from "@/components/ui/inputs/InputPassword";
import {
...
Form.InputDragfile = createFormInputComponent<InputDragFileProps>(
  InputDragFileComponent,
);
Form.InputCheckBox = createFormInputComponent<InputCheckboxProps>(
  InputCheckboxComponent,
);
Form.InputNumber =
  createFormInputComponent<InputNumberProps>(InputNumberComponent);
Form.InputPassword = createFormInputComponent<InputPasswordProps>(
